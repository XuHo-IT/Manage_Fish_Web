...
namespace ChatbotAPI.Controllers
{
    ...
    public class ChatbotController : ControllerBase
    {
        ...
        {
            { "What types of fish do you sell?", "We sell a variety of fish including salmon, tilapia, and tuna." },
            { "Do you sell live fish or only frozen fish?", "We sell both live and frozen fish to meet different customer needs." },
            ...
            { "Where is your store located?", "Our store is located at 123 Fish Market Street, City Center." },
            ...
            { "Is there a minimum order requirement?", "The minimum order requirement is $20." },
            ...
            { "How is the fish packaged for delivery?", "All fish are packed in insulated containers with ice to maintain freshness." },
            { "Can I schedule a specific delivery date?", "Yes, you can select your preferred delivery date during checkout." },
            ...
            { "What is the freshest fish you have today?", "Our freshest fish today includes wild-caught salmon and sea bass." },
